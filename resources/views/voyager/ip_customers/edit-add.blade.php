...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('voyager::generic.'.(!is_null($dataTypeContent->getKey()) ? 'edit' : 'add')).' '.$dataType->display_name_singular . ' ( IP có thể nhập cùng 1 lúc nhiều IP dưới dạng: x.x.x.x,x.x.x.x,x.x.x.x......)' }}
    </h1>
